...
@Entity
@Table(name = "Artiste")
@NamedQueries({ @NamedQuery(name = "Artiste.findAll", query = "SELECT a FROM Artiste a"),
...
public class Artiste implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idArtiste == null && other.idArtiste != null)
                || (this.idArtiste != null && !this.idArtiste.equals(other.idArtiste))) {
            return false;
        }
        return true;
    }
